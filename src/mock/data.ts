...
export const mockCases: Case[] = [
  ...
  // ─── Native demo case ─────────────────────────────────────────────────────
  {
    ...
    status: 'intake',
    specialOrders: [],
    physician: 'Dr. Lisa Hoffman',
  },

  // ─── Additional cases for list variety ───────────────────────────────────
  {
    id: 'case-a1',
    ...
    panelType: 'renal',
    specimenCategory: 'native_kidney',
    patient: { id: 'pat-a1', medicalRecordNumber: 'MRN-3301', firstName: 'Marcus', lastName: 'Webb', dateOfBirth: '1963-03-17' },
    receivedAt: '2026-04-29T08:22:00',
    submittingState: 'OK',
    materials: [formalin('mat-a1-a'), michels('mat-a1-b'), glute('mat-a1-c')],
    panels: { numberOfCores: 3, lymphNodeCount: 2, immunofluorescenceCount: 1 },
    flags: [],
    status: 'submitted',
    specialOrders: [],
  ...
  },
  {
    ...
    panelType: 'renal',
    specimenCategory: 'kidney_transplant',
    patient: { id: 'pat-a2', medicalRecordNumber: 'MRN-8812', firstName: 'Carmen', lastName: 'Reyes', dateOfBirth: '1970-09-05' },
    receivedAt: '2026-04-28T13:45:00',
    submittingState: 'TX',
    materials: [formalin('mat-a2-a'), michels('mat-a2-b')],
    panels: { numberOfCores: 4, lymphNodeCount: 3, immunofluorescenceCount: 1 },
    flags: [],
    status: 'finalized',
    specialOrders: [],
  ...
  {
    id: 'case-a3',
    accessionNumber: 'S26-12578',
    caseType: 'Surgical',
    panelType: 'renal',
    specimenCategory: 'native_kidney',
    patient: { id: 'pat-a3', medicalRecordNumber: 'MRN-5544', firstName: 'Theodore', lastName: 'Grant', dateOfBirth: '1956-12-11' },
    receivedAt: '2026-04-29T14:05:00',
    submittingState: 'AR',
    materials: [formalin('mat-a3-a'), michels('mat-a3-b')],
    panels: { numberOfCores: 5, lymphNodeCount: 4, immunofluorescenceCount: 2 },
    flags: ['fatty'],
    status: 'in_grossing',
    specialOrders: [],
    physician: 'Dr. Emily Chen',
  },
  {
    ...
    panelType: 'renal',
    specimenCategory: 'native_kidney',
    patient: { id: 'pat-a4', medicalRecordNumber: 'MRN-6620', firstName: 'Nadia', lastName: 'Petrov', dateOfBirth: '1982-06-24' },
    receivedAt: '2026-04-27T09:30:00',
    submittingState: 'MO',
    materials: [formalin('mat-a4-a'), michels('mat-a4-b'), glute('mat-a4-c')],
    panels: { numberOfCores: 3, lymphNodeCount: 2, immunofluorescenceCount: 1 },
    flags: [],
    status: 'finalized',
    specialOrders: [],
  ...
  {
    id: 'case-a5',
    accessionNumber: 'S26-12534',
    caseType: 'Preimplantation Kidney Biopsy',
    panelType: 'renal',
    specimenCategory: 'pre_implantation',
    patient: { id: 'pat-a5', medicalRecordNumber: 'MRN-7799', firstName: 'Leon', lastName: 'Fischer', dateOfBirth: '1948-11-30' },
    receivedAt: '2026-04-29T15:18:00',
    submittingState: 'LA',
    materials: [formalin('mat-a5-a')],
    panels: { numberOfCores: 2, lymphNodeCount: 1, immunofluorescenceCount: 0 },
    flags: [],
    status: 'intake',
    specialOrders: [],
